...
namespace MJCollections.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductId,Name,ProductTypeId,Description,Packaging,Remarks,Creator,CreateDate")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductId,Name,ProductTypeId,Description,Packaging,Remarks,Creator,CreateDate")] Product product)
        {
            if (ModelState.IsValid)
            {
